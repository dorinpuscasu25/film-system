    ...
    public function run(): void
    {
        $contents = [
            [
                ...
                'offers' => [
                    ['name' => '2 days SD', 'offer_type' => Offer::TYPE_RENTAL, 'quality' => 'HD', 'price_amount' => 4.99, 'currency' => 'USD', 'playback_url' => 'https://storage.filmoteca.md/playback/carbon-hd.mp4', 'rental_days' => 2, 'sort_order' => 10],
                    ['name' => 'Forever SD', 'offer_type' => Offer::TYPE_LIFETIME, 'quality' => 'HD', 'price_amount' => 9.99, 'currency' => 'USD', 'playback_url' => 'https://storage.filmoteca.md/playback/carbon-hd.mp4', 'sort_order' => 20],
                    ['name' => 'Forever Full HD', 'offer_type' => Offer::TYPE_LIFETIME, 'quality' => 'Full HD', 'price_amount' => 12.99, 'currency' => 'USD', 'playback_url' => 'https://storage.filmoteca.md/playback/carbon-fullhd.mp4', 'sort_order' => 30],
                ],
            ],
            [
                'type' => Content::TYPE_MOVIE,
                ...
                'offers' => [
                    ['name' => '2 days HD', 'offer_type' => Offer::TYPE_RENTAL, 'quality' => 'HD', 'price_amount' => 3.99, 'currency' => 'USD', 'playback_url' => 'https://storage.filmoteca.md/playback/teambuilding-hd.mp4', 'rental_days' => 2, 'sort_order' => 10],
                    ['name' => '2 days Full HD', 'offer_type' => Offer::TYPE_RENTAL, 'quality' => 'Full HD', 'price_amount' => 4.99, 'currency' => 'USD', 'playback_url' => 'https://storage.filmoteca.md/playback/teambuilding-fullhd.mp4', 'rental_days' => 2, 'sort_order' => 20],
                    ['name' => 'Forever 4K', 'offer_type' => Offer::TYPE_LIFETIME, 'quality' => '4K', 'price_amount' => 14.99, 'currency' => 'USD', 'playback_url' => 'https://storage.filmoteca.md/playback/teambuilding-4k.mp4', 'sort_order' => 30],
                ],
            ],
            [
                'type' => Content::TYPE_MOVIE,
            ...
            [
                ...
                'offers' => [
                    ['name' => '7 days HD', 'offer_type' => Offer::TYPE_RENTAL, 'quality' => 'HD', 'price_amount' => 5.99, 'currency' => 'USD', 'playback_url' => 'https://storage.filmoteca.md/playback/hackerville-hd.m3u8', 'rental_days' => 7, 'sort_order' => 10],
                    ['name' => '30 days Full HD', 'offer_type' => Offer::TYPE_RENTAL, 'quality' => 'Full HD', 'price_amount' => 8.99, 'currency' => 'USD', 'playback_url' => 'https://storage.filmoteca.md/playback/hackerville-fullhd.m3u8', 'rental_days' => 30, 'sort_order' => 20],
                    ['name' => 'Forever Full HD', 'offer_type' => Offer::TYPE_LIFETIME, 'quality' => 'Full HD', 'price_amount' => 18.99, 'currency' => 'USD', 'playback_url' => 'https://storage.filmoteca.md/playback/hackerville-fullhd.m3u8', 'sort_order' => 30],
                ],
            ],
        ];
