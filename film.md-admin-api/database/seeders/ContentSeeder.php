    ...
    public function run(): void
    {
        $contents = [
            [
                ...
                'meta_title' => ['ro' => 'Carbon pe filmoteca.md', 'ru' => 'Карбон на filmoteca.md', 'en' => 'Carbon on filmoteca.md'],
                'meta_description' => ['ro' => 'Vezi Carbon online pe filmoteca.md.', 'ru' => 'Смотрите Карбон онлайн на filmoteca.md.', 'en' => 'Watch Carbon online on filmoteca.md.'],
                'release_year' => 2022,
                'country_code' => 'MD',
                'imdb_rating' => 8.3,
                'platform_rating' => 4.7,
                ...
                'offers' => [
                    ['name' => '2 days SD', 'offer_type' => Offer::TYPE_RENTAL, 'quality' => 'HD', 'price_amount' => 4.99, 'currency' => 'MDL', 'playback_url' => 'https://storage.filmoteca.md/playback/carbon-hd.mp4', 'rental_days' => 2, 'sort_order' => 10],
                    ['name' => 'Forever SD', 'offer_type' => Offer::TYPE_LIFETIME, 'quality' => 'HD', 'price_amount' => 9.99, 'currency' => 'MDL', 'playback_url' => 'https://storage.filmoteca.md/playback/carbon-hd.mp4', 'sort_order' => 20],
                    ['name' => 'Forever Full HD', 'offer_type' => Offer::TYPE_LIFETIME, 'quality' => 'Full HD', 'price_amount' => 12.99, 'currency' => 'MDL', 'playback_url' => 'https://storage.filmoteca.md/playback/carbon-fullhd.mp4', 'sort_order' => 30],
                ],
            ],
            [
                'type' => Content::TYPE_MOVIE,
                ...
                'meta_description' => ['ro' => 'Comedia Teambuilding disponibilă pe filmoteca.md.', 'ru' => 'Комедия Тимбилдинг доступна на filmoteca.md.', 'en' => 'The comedy Teambuilding is available on filmoteca.md.'],
                'release_year' => 2022,
                'country_code' => 'RO',
                'imdb_rating' => 6.7,
                'platform_rating' => 4.2,
                ...
                'offers' => [
                    ['name' => '2 days HD', 'offer_type' => Offer::TYPE_RENTAL, 'quality' => 'HD', 'price_amount' => 3.99, 'currency' => 'MDL', 'playback_url' => 'https://storage.filmoteca.md/playback/teambuilding-hd.mp4', 'rental_days' => 2, 'sort_order' => 10],
                    ['name' => '2 days Full HD', 'offer_type' => Offer::TYPE_RENTAL, 'quality' => 'Full HD', 'price_amount' => 4.99, 'currency' => 'MDL', 'playback_url' => 'https://storage.filmoteca.md/playback/teambuilding-fullhd.mp4', 'rental_days' => 2, 'sort_order' => 20],
                    ['name' => 'Forever 4K', 'offer_type' => Offer::TYPE_LIFETIME, 'quality' => '4K', 'price_amount' => 14.99, 'currency' => 'MDL', 'playback_url' => 'https://storage.filmoteca.md/playback/teambuilding-4k.mp4', 'sort_order' => 30],
                ],
            ],
            [
                'type' => Content::TYPE_MOVIE,
                ...
                'meta_title' => ['ro' => 'Afacerea Est pe filmoteca.md', 'ru' => 'Восточное дело на filmoteca.md', 'en' => 'Eastern Business on filmoteca.md'],
                'meta_description' => ['ro' => 'Descoperă Afacerea Est pe filmoteca.md.', 'ru' => 'Откройте для себя Восточное дело на filmoteca.md.', 'en' => 'Discover Eastern Business on filmoteca.md.'],
                'release_year' => 2016,
                'country_code' => 'MD',
                'imdb_rating' => 7.4,
                'platform_rating' => 4.4,
            ...
            [
                ...
                'offers' => [
                    ['name' => '7 days HD', 'offer_type' => Offer::TYPE_RENTAL, 'quality' => 'HD', 'price_amount' => 5.99, 'currency' => 'MDL', 'playback_url' => 'https://storage.filmoteca.md/playback/hackerville-hd.m3u8', 'rental_days' => 7, 'sort_order' => 10],
                    ['name' => '30 days Full HD', 'offer_type' => Offer::TYPE_RENTAL, 'quality' => 'Full HD', 'price_amount' => 8.99, 'currency' => 'MDL', 'playback_url' => 'https://storage.filmoteca.md/playback/hackerville-fullhd.m3u8', 'rental_days' => 30, 'sort_order' => 20],
                    ['name' => 'Forever Full HD', 'offer_type' => Offer::TYPE_LIFETIME, 'quality' => 'Full HD', 'price_amount' => 18.99, 'currency' => 'MDL', 'playback_url' => 'https://storage.filmoteca.md/playback/hackerville-fullhd.m3u8', 'sort_order' => 30],
                ],
            ],
        ];
        ...
        foreach ($contents as $item) {
            $content = Content::query()->updateOrCreate(
                ...
                [
                    ...
                    'country_codes' => $item['country_codes'] ?? [$item['country_code']],
