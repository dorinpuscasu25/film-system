...
Route::prefix('v1')->group(function (): void {
    ...
    Route::prefix('public')->group(function (): void {
        ...
        Route::get('images/resize', [PublicImageController::class, 'resize']);
    ...
    Route::middleware('api.token')->group(function (): void {
        ...
        Route::prefix('admin')->middleware('admin.panel')->group(function (): void {
            ...
            Route::patch('users/{user}/verify-email', [UserController::class, 'verifyEmail'])->middleware('permission:users.edit');
